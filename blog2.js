document.addEventListener('DOMContentLoaded', function() {
    ...
    if(localStorage.getItem('num-clicks2') == null) {
        localStorage.setItem('num-clicks2', 0);
    }

    let previousNumClicks = parseInt(localStorage.getItem('num-clicks2'));
    if(localStorage.getItem('comments2') == null) {
        localStorage.setItem('comments2', []);
    }

    let currentComments = [];
    let currentCommentsJSON = localStorage.getItem('comments2');
    ...
    heartClickId.addEventListener('click', function(event) {
        ...
        localStorage.setItem('num-clicks2', currentNumClicks);
    ...
    commentSubmitButtonId.addEventListener('click', function(event) {
        ...
        if(inputText.trim() !== '') {
            ...
            localStorage.setItem('comments2', JSON.stringify(currentComments));
            updateComments();
            // let newCommentDiv = document.createElement('div');
